...
//xp bar 
draw_healthbar(camera_get_view_x(view_camera[0]) + 288, camera_get_view_y(view_camera[0]) + 540, camera_get_view_x(view_camera[0]) + 864, camera_get_view_y(view_camera[0]) + 560, obj_player_pastry.level_up_threshold_ui, c_green, c_black, c_black, 1, true, true)

//draw level above healthbar
draw_set_font(fnt_ui)
draw_set_halign(fa_center)
draw_set_color(c_green)
draw_text(camera_get_view_x(view_camera[0]) + (camera_get_view_width(view_camera[0]) / 2), camera_get_view_y(view_camera[0]) + 500 , "Level " + string(get_level(obj_player_pastry)))
